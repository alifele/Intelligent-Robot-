...
Serial.print("AngleX= "); Serial.println(int(x)%360);

Serial.print("AngleY= "); Serial.println(int(y)%360);

Serial.print("AngleZ= "); Serial.println(int(z)%360); Serial.println("-----------------------------------------"); delay(2000); }
